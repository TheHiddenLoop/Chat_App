...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>We received a request to reset your password for your Chatty account. Click the button below to proceed:</p>
    ...
    <p>If you didn’t request a password reset, please ignore this email or contact Chatty support.</p>
    <p>Best regards,<br><strong>The Chatty Team</strong></p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message from Chatty, please do not reply.</p>
  </div>
</body>
</html>
`;
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>Your password for Chatty has been successfully reset.</p>
    <div style="text-align: center; margin: 30px 0;">
    ...
    <p>If you did not initiate this password reset, please contact Chatty support immediately.</p>
    <p>For added security, we recommend:</p>
    <ul>
      <li>Using a strong, unique password</li>
      <li>Enabling two-factor authentication</li>
      <li>Avoiding reusing passwords across multiple sites</li>
    </ul>
    <p>Best regards,<br><strong>The Chatty Team</strong></p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
