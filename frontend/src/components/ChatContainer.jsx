...
const ChatContainer = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-[calc(100vh-4rem)] overflow-hidden bg-gradient-to-b from-base-100 to-base-200">
      <ChatHeader />
    ...
    ${isAuthUserMessage ? "bg-primary text-primary-content" : "bg-base-100 text-base-content border border-base-300"}
  `}
                  >
                    {message.image && (
                    ...
                    {message.text && (
                      <div
                        className={`${
                          message.image ? "mt-2 w-[130px] sm:w-[200px]" : "w-full max-w-[70vw] sm:max-w-md"
                        }`}
                      >
