  ...
  <div className="overflow-y-auto max-h-96 p-2 space-y-2 rounded-md ">
    <ul>
      {(filteredResults.length > 0 ? filteredResults : searchResults).map((user) => (
        <li key={user._id} className="p-4 flex flex-col rounded-lg border shadow-md mb-4">
          ...
          <button
            ...
            className="w-full p-2 flex items-center justify-center space-x-2 bg-primary  rounded-md hover:bg-primary/90"
          >
            <UserPlus className="w-5 h-5" />
